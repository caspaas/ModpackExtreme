...
#define SHADOWDISTANCE 51.2 
#define SHADOW_CLAMP 0.5
#define SHADOW_RES 512.0

/* SHADOWRES:512 */				//affect shadow map resolution (change SHADOW_RES with it!)
/* SHADOWHPL:51.2 */				//affect shadow map draw distance (change SHADOWDISTANCE with it!)
