...
//colors for shadows/sunlight and sky
	...
	colorSkylight.g *= 0.95f;
	 ...
	 vec3 colorSkylight_rain = vec3(2.0, 2.0, 2.38) * 0.5f * (1.0f - timeMidnight * 0.95f); //rain
	...
	colorSunlight = mix(colorSunlight, colorSunlight * 0.15f, timeMidnight);
	...
	colorBouncedSunlight = mix(colorBouncedSunlight, colorBouncedSunlight * 0.005f, timeMidnight);
	...
	colorScatteredSunlight = mix(colorScatteredSunlight, colorScatteredSunlight * 0.005f, timeMidnight);
